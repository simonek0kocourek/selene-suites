...
npm install lenis@^1.3.13
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/ScrollStack-TS-TW
```
...
Source folder: `components/scroll-stack.md`
