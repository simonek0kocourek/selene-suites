...
```bash
npx jsrepo@latest add https://reactbits.dev/r/Lanyard-TS-TW
```
...
- `Lanyard/card.glb` (binary asset; keep beside the component when copying manually)
- `Lanyard/lanyard.png` (binary asset; keep beside the component when copying manually)

Source folder: `components/lanyard.md`
