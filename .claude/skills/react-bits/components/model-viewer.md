...
npm install @react-three/fiber@^9.3.0 @react-three/drei@^10.7.4 three@^0.167.1
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/ModelViewer-TS-TW
```
...
Source folder: `components/model-viewer.md`
