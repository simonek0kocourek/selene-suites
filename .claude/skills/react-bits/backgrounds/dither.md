...
npm install @react-three/fiber@^9.3.0 @react-three/postprocessing@^3.0.4 postprocessing@^6.36.0 three@^0.167.1
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/Dither-TS-TW
```

## Best Website Fit

- Use as a controlled backdrop for hero or featured sections.
- Fit best when "Dither" supports the visual tone of the page more than the content hierarchy.
...
Source folder: `backgrounds/dither.md`
