...
```bash
npx jsrepo@latest add https://reactbits.dev/r/GradientBlinds-TS-TW
```

## Best Website Fit

- Use as a controlled backdrop for hero or featured sections.
- Fit best when "GradientBlinds" supports the visual tone of the page more than the content hierarchy.
...
### GradientBlinds/GradientBlinds.tsx
...
Source folder: `backgrounds/gradient-blinds.md`
