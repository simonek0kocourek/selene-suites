...
npm install gsap@^3.13.0 three@^0.167.1
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/Ballpit-TS-TW
```

## Best Website Fit

- Use as a controlled backdrop for hero or featured sections.
- Fit best when "Ballpit" supports the visual tone of the page more than the content hierarchy.
...
Source folder: `backgrounds/ballpit.md`
