...
npm install face-api.js@^0.22.2 postprocessing@^6.36.0 three@^0.167.1
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/GridScan-TS-TW
```
...
Source folder: `backgrounds/grid-scan.md`
