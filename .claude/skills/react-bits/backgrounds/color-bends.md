...
```bash
npx jsrepo@latest add https://reactbits.dev/r/ColorBends-TS-TW
```

## Best Website Fit

- Use as a controlled backdrop for hero or featured sections.
- Fit best when "ColorBends" supports the visual tone of the page more than the content hierarchy.
...
Source folder: `backgrounds/color-bends.md`
