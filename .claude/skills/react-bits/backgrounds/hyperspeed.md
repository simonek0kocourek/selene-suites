...
npm install postprocessing@^6.36.0 three@^0.167.1
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/Hyperspeed-TS-TW
```
...
### Hyperspeed/HyperSpeedPresets.ts
...
Source folder: `backgrounds/hyperspeed.md`
