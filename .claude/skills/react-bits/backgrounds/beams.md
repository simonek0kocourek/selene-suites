...
npm install three@^0.167.1 @react-three/fiber@^9.3.0 @react-three/drei@^10.7.4
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/Beams-TS-TW
```
...
Source folder: `backgrounds/beams.md`
