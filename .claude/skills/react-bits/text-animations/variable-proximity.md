...
```bash
npx jsrepo@latest add https://reactbits.dev/r/VariableProximity-TS-TW
```
...
### VariableProximity/VariableProximity.tsx
...
Source folder: `text-animations/variable-proximity.md`
