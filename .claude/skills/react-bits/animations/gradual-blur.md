...
npm install mathjs@^14.6.0
```

Fallback:

```bash
npx jsrepo@latest add https://reactbits.dev/r/GradualBlur-TS-TW
```
...
Source folder: `animations/gradual-blur.md`
